...
ReferenceImages = ["rectangle.jpg","diamond.jpg","triangle.jpg","circle.jpg","oval.jpg","square.jpg"]
ReferenceTitles = ["rectangle","diamond","triangle","circle","oval","square"]
...
def readRefImages():
    for count in range(6):
        ...
        symbol[count].img = cv2.resize(image,(640,280),interpolation = cv2.INTER_AREA)
